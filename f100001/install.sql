...
@@application/shared_components/user_interface/lovs/tasks_lov.sql
...
@@application/shared_components/automations/job.sql
@@application/shared_components/security/authentications/oracle_apex_accounts.sql
@@application/shared_components/plugins/dynamic_action/task_board.sql
@@application/shared_components/plugins/dynamic_action/dragndrop.sql
@@application/shared_components/plugins/dynamic_action/board.sql
...
@@application/deployment/install/upgrade_job_activate.sql
