...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(12084736033452772)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12085036762452777)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12085350379452777)
,p_page_template_id=>wwv_flow_imp.id(12084736033452772)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12085686553452777)
,p_page_template_id=>wwv_flow_imp.id(12084736033452772)
