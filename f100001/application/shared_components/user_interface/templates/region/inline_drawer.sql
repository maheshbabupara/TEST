...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(12149300402452822)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12149620213452822)
,p_plug_template_id=>wwv_flow_imp.id(12149300402452822)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12149972171452822)
,p_plug_template_id=>wwv_flow_imp.id(12149300402452822)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12150212467452823)
,p_plug_template_id=>wwv_flow_imp.id(12149300402452822)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12150574450452823)
,p_plug_template_id=>wwv_flow_imp.id(12149300402452822)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12150826883452823)
,p_plug_template_id=>wwv_flow_imp.id(12149300402452822)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12151176796452823)
,p_plug_template_id=>wwv_flow_imp.id(12149300402452822)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12151408021452823)
,p_plug_template_id=>wwv_flow_imp.id(12149300402452822)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12151793566452823)
,p_plug_template_id=>wwv_flow_imp.id(12149300402452822)
,p_name=>'Sub Regions'
