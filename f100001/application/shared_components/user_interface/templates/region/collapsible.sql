...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(12129616560452812)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12129975101452812)
,p_plug_template_id=>wwv_flow_imp.id(12129616560452812)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12130268803452812)
,p_plug_template_id=>wwv_flow_imp.id(12129616560452812)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12130500153452813)
,p_plug_template_id=>wwv_flow_imp.id(12129616560452812)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12130845790452813)
,p_plug_template_id=>wwv_flow_imp.id(12129616560452812)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12131100081452813)
,p_plug_template_id=>wwv_flow_imp.id(12129616560452812)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12131409512452813)
,p_plug_template_id=>wwv_flow_imp.id(12129616560452812)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12131718507452813)
,p_plug_template_id=>wwv_flow_imp.id(12129616560452812)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12132022593452813)
,p_plug_template_id=>wwv_flow_imp.id(12129616560452812)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12132336581452813)
,p_plug_template_id=>wwv_flow_imp.id(12129616560452812)
,p_name=>'Sub Regions'
