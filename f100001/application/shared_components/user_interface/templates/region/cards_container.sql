...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(12127792649452811)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12128058461452811)
,p_plug_template_id=>wwv_flow_imp.id(12127792649452811)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12128367282452811)
,p_plug_template_id=>wwv_flow_imp.id(12127792649452811)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12128623029452811)
,p_plug_template_id=>wwv_flow_imp.id(12127792649452811)
,p_name=>'Sub Regions'
