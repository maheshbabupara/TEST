...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(12173448086452836)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12173745145452836)
,p_plug_template_id=>wwv_flow_imp.id(12173448086452836)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12174061260452836)
,p_plug_template_id=>wwv_flow_imp.id(12173448086452836)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12174362749452836)
,p_plug_template_id=>wwv_flow_imp.id(12173448086452836)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12174650620452837)
,p_plug_template_id=>wwv_flow_imp.id(12173448086452836)
,p_name=>'Sub Regions'
