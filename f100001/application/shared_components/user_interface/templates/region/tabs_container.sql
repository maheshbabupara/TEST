...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(12190888355452844)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12191190048452845)
,p_plug_template_id=>wwv_flow_imp.id(12190888355452844)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12191482292452845)
,p_plug_template_id=>wwv_flow_imp.id(12190888355452844)
,p_name=>'Tabs'
