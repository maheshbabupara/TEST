...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(12161670575452829)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12161901771452830)
,p_plug_template_id=>wwv_flow_imp.id(12161670575452829)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12162210399452830)
,p_plug_template_id=>wwv_flow_imp.id(12161670575452829)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12162574332452830)
,p_plug_template_id=>wwv_flow_imp.id(12161670575452829)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12162895431452830)
,p_plug_template_id=>wwv_flow_imp.id(12161670575452829)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12163142367452830)
,p_plug_template_id=>wwv_flow_imp.id(12161670575452829)
,p_name=>'Sub Regions'
