...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(12139791572452818)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12140008389452818)
,p_plug_template_id=>wwv_flow_imp.id(12139791572452818)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12140349739452818)
,p_plug_template_id=>wwv_flow_imp.id(12139791572452818)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12140655837452818)
,p_plug_template_id=>wwv_flow_imp.id(12139791572452818)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12140983573452818)
,p_plug_template_id=>wwv_flow_imp.id(12139791572452818)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12141225553452818)
,p_plug_template_id=>wwv_flow_imp.id(12139791572452818)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12141514050452818)
,p_plug_template_id=>wwv_flow_imp.id(12139791572452818)
,p_name=>'Sub Regions'
