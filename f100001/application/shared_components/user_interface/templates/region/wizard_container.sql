...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(12198258650452848)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12198593508452848)
,p_plug_template_id=>wwv_flow_imp.id(12198258650452848)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12198804288452848)
,p_plug_template_id=>wwv_flow_imp.id(12198258650452848)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12199173859452849)
,p_plug_template_id=>wwv_flow_imp.id(12198258650452848)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12199483857452849)
,p_plug_template_id=>wwv_flow_imp.id(12198258650452848)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12199769662452849)
,p_plug_template_id=>wwv_flow_imp.id(12198258650452848)
