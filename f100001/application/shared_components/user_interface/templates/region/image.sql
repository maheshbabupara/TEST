...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(12143951871452820)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12144213224452820)
,p_plug_template_id=>wwv_flow_imp.id(12143951871452820)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12144597353452820)
,p_plug_template_id=>wwv_flow_imp.id(12143951871452820)
,p_name=>'Sub Regions'
