...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(12159567638452828)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12159823448452828)
,p_plug_template_id=>wwv_flow_imp.id(12159567638452828)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12160166445452828)
,p_plug_template_id=>wwv_flow_imp.id(12159567638452828)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12160430041452828)
,p_plug_template_id=>wwv_flow_imp.id(12159567638452828)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12160763300452828)
,p_plug_template_id=>wwv_flow_imp.id(12159567638452828)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12161000307452829)
,p_plug_template_id=>wwv_flow_imp.id(12159567638452828)
,p_name=>'Sub Regions'
