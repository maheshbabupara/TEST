...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(8144797397433415)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8145078789433415)
,p_plug_template_id=>wwv_flow_api.id(8144797397433415)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8145384659433415)
,p_plug_template_id=>wwv_flow_api.id(8144797397433415)
,p_name=>'Sub Regions'
