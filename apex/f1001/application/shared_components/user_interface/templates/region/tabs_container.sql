...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(8201514817433443)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8201893936433443)
,p_plug_template_id=>wwv_flow_api.id(8201514817433443)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8202194358433443)
,p_plug_template_id=>wwv_flow_api.id(8201514817433443)
,p_name=>'Tabs'
