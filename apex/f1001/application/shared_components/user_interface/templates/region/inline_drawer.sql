...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(8177766048433432)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8178048176433432)
,p_plug_template_id=>wwv_flow_api.id(8177766048433432)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8178350077433432)
,p_plug_template_id=>wwv_flow_api.id(8177766048433432)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8178674055433433)
,p_plug_template_id=>wwv_flow_api.id(8177766048433432)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8178939359433433)
,p_plug_template_id=>wwv_flow_api.id(8177766048433432)
,p_name=>'Delete'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8179210366433433)
,p_plug_template_id=>wwv_flow_api.id(8177766048433432)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8179550157433433)
,p_plug_template_id=>wwv_flow_api.id(8177766048433432)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8179873366433433)
,p_plug_template_id=>wwv_flow_api.id(8177766048433432)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8180138563433433)
,p_plug_template_id=>wwv_flow_api.id(8177766048433432)
,p_name=>'Sub Regions'
