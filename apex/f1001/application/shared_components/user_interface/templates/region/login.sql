...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(8189545150433437)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8189847947433437)
,p_plug_template_id=>wwv_flow_api.id(8189545150433437)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8190126424433438)
,p_plug_template_id=>wwv_flow_api.id(8189545150433437)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8190498264433438)
,p_plug_template_id=>wwv_flow_api.id(8189545150433437)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8190754145433438)
,p_plug_template_id=>wwv_flow_api.id(8189545150433437)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8191064392433438)
,p_plug_template_id=>wwv_flow_api.id(8189545150433437)
,p_name=>'Sub Regions'
