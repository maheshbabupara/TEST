...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(8169942070433429)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8170225305433429)
,p_plug_template_id=>wwv_flow_api.id(8169942070433429)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8170520520433429)
,p_plug_template_id=>wwv_flow_api.id(8169942070433429)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8170841504433429)
,p_plug_template_id=>wwv_flow_api.id(8169942070433429)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8171187637433429)
,p_plug_template_id=>wwv_flow_api.id(8169942070433429)
,p_name=>'Sub Regions'
