...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(8165712616433427)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8166013053433427)
,p_plug_template_id=>wwv_flow_api.id(8165712616433427)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8166303769433427)
,p_plug_template_id=>wwv_flow_api.id(8165712616433427)
,p_name=>'Change'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8166658097433427)
,p_plug_template_id=>wwv_flow_api.id(8165712616433427)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8166983938433427)
,p_plug_template_id=>wwv_flow_api.id(8165712616433427)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8167200126433428)
,p_plug_template_id=>wwv_flow_api.id(8165712616433427)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(8167522880433428)
,p_plug_template_id=>wwv_flow_api.id(8165712616433427)
,p_name=>'Sub Regions'
