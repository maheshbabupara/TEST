...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(8127559990433407)
,p_theme_id=>42
,p_name=>'Standard'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8127899672433408)
,p_page_template_id=>wwv_flow_api.id(8127559990433407)
,p_name=>'After Logo'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8128173065433408)
,p_page_template_id=>wwv_flow_api.id(8127559990433407)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8128400856433408)
,p_page_template_id=>wwv_flow_api.id(8127559990433407)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8128734195433408)
,p_page_template_id=>wwv_flow_api.id(8127559990433407)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8129095150433408)
,p_page_template_id=>wwv_flow_api.id(8127559990433407)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8129341055433408)
,p_page_template_id=>wwv_flow_api.id(8127559990433407)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8129666358433408)
,p_page_template_id=>wwv_flow_api.id(8127559990433407)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8129958918433408)
,p_page_template_id=>wwv_flow_api.id(8127559990433407)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8130218418433409)
,p_page_template_id=>wwv_flow_api.id(8127559990433407)
,p_name=>'Banner'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8130547045433409)
,p_page_template_id=>wwv_flow_api.id(8127559990433407)
