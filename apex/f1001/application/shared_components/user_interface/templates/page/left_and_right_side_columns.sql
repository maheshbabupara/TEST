...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(8108674776433399)
,p_theme_id=>42
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8108935747433399)
,p_page_template_id=>wwv_flow_api.id(8108674776433399)
,p_name=>'After Logo'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8109241621433399)
,p_page_template_id=>wwv_flow_api.id(8108674776433399)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8109589448433400)
,p_page_template_id=>wwv_flow_api.id(8108674776433399)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8109827376433400)
,p_page_template_id=>wwv_flow_api.id(8108674776433399)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8110197414433400)
,p_page_template_id=>wwv_flow_api.id(8108674776433399)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8110411714433400)
,p_page_template_id=>wwv_flow_api.id(8108674776433399)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8110706550433400)
,p_page_template_id=>wwv_flow_api.id(8108674776433399)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8111074156433400)
,p_page_template_id=>wwv_flow_api.id(8108674776433399)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8111386526433400)
,p_page_template_id=>wwv_flow_api.id(8108674776433399)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8111677976433400)
,p_page_template_id=>wwv_flow_api.id(8108674776433399)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8111948530433401)
,p_page_template_id=>wwv_flow_api.id(8108674776433399)
,p_name=>'Banner'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8112284626433401)
,p_page_template_id=>wwv_flow_api.id(8108674776433399)
