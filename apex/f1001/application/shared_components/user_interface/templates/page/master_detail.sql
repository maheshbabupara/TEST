...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(8114930321433402)
,p_theme_id=>42
,p_name=>'Marquee'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8115218607433402)
,p_page_template_id=>wwv_flow_api.id(8114930321433402)
,p_name=>'After Logo'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8115568457433402)
,p_page_template_id=>wwv_flow_api.id(8114930321433402)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8115843955433402)
,p_page_template_id=>wwv_flow_api.id(8114930321433402)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8116149652433402)
,p_page_template_id=>wwv_flow_api.id(8114930321433402)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8116470892433403)
,p_page_template_id=>wwv_flow_api.id(8114930321433402)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8116754197433403)
,p_page_template_id=>wwv_flow_api.id(8114930321433402)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8117004350433403)
,p_page_template_id=>wwv_flow_api.id(8114930321433402)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8117374316433403)
,p_page_template_id=>wwv_flow_api.id(8114930321433402)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8117600947433403)
,p_page_template_id=>wwv_flow_api.id(8114930321433402)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8117954693433403)
,p_page_template_id=>wwv_flow_api.id(8114930321433402)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8118251527433403)
,p_page_template_id=>wwv_flow_api.id(8114930321433402)
,p_name=>'Banner'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8118565419433403)
,p_page_template_id=>wwv_flow_api.id(8114930321433402)
