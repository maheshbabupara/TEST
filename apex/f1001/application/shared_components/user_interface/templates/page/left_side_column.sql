...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(8104966999433398)
,p_theme_id=>42
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8105268704433398)
,p_page_template_id=>wwv_flow_api.id(8104966999433398)
,p_name=>'After Logo'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8105565453433398)
,p_page_template_id=>wwv_flow_api.id(8104966999433398)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8105883080433398)
,p_page_template_id=>wwv_flow_api.id(8104966999433398)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8106133070433398)
,p_page_template_id=>wwv_flow_api.id(8104966999433398)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8106463771433398)
,p_page_template_id=>wwv_flow_api.id(8104966999433398)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8106799635433398)
,p_page_template_id=>wwv_flow_api.id(8104966999433398)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8107012595433398)
,p_page_template_id=>wwv_flow_api.id(8104966999433398)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8107332222433399)
,p_page_template_id=>wwv_flow_api.id(8104966999433398)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8107616896433399)
,p_page_template_id=>wwv_flow_api.id(8104966999433398)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8107961879433399)
,p_page_template_id=>wwv_flow_api.id(8104966999433398)
,p_name=>'Banner'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(8108251970433399)
,p_page_template_id=>wwv_flow_api.id(8104966999433398)
